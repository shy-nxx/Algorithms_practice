...
public class DFS_2468_safe_area {
    /**
     * 먼저 어떤 지역의 높이 정보를 파악한다. 그 다음에 그 지역에 많은 비가 내렸을 때 물에 잠기지 않는 안전한 영역이 최대로 몇 개가 만들어 지는 지를 조사하려고 한다. 이때, 문제를 간단하게 하기 위하여, 장마철에 내리는 비의 양에 따라 일정한 높이 이하의 모든 지점은 물에 잠긴다고 가정한다.
     * <p>
    ...
    public static void main(String[] args) throws IOException {
        ...
        /**
         * 먼저 기준이 되는 높이 이하의 칸들을 제외하고
         * 제외된 칸이외의 칸들의 개수를 dfs로 구한다.
         */
